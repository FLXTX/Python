...
print()
print("A bold hero named Sir " + name + " sang opera.")
print()
print("While wearing a hat made of " + hat_noun + "on his head.")
print()
print("He danced with a " + color + " penguin, 'til they both fell in [liquid].")
print()
...
print()
print("There you go " + name + ", that was quite the adventure") 